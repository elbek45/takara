              ...
              <div key={pool.id} className="card hover:border-takara-gold transition-all">
                ...
                <div className="mb-4">
                  ...
                  <div className="text-sm text-white">
                    ${Number(pool.minInvestment).toLocaleString()} - ${Number(pool.maxInvestment).toLocaleString()}
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between text-xs text-gray-400 mt-1">
                    <span>${Number(pool.currentAmount).toLocaleString()}</span>
                    <span>${Number(pool.targetAmount).toLocaleString()}</span>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-lg font-semibold text-white">
                      ${Number(selectedPool.minInvestment).toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Maximum Investment</div>
                    <div className="text-lg font-semibold text-white">
                      ${Number(selectedPool.maxInvestment).toLocaleString()}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="text-lg font-semibold text-white">
                      ${Number(selectedPool.targetAmount).toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Current Amount</div>
                    <div className="text-lg font-semibold text-takara-gold">
                      ${Number(selectedPool.currentAmount).toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Remaining</div>
                    <div className="text-lg font-semibold text-gray-300">
                      ${(Number(selectedPool.targetAmount) - Number(selectedPool.currentAmount)).toLocaleString()}
                    </div>
                  </div>
                </div>
